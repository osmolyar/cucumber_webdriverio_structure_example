...
class AddTablesModalLocators extends BaseModalPage {

    get selectSchema() {return $('//*[@id="control_10"]')};

    get addOneTable() {return $('//*[@id="selectBoxes"]/table/tbody/tr[2]/td[2]/div[1]/img')};
    get addAllTables() {return $('//*[@id="selectBoxes"]/table/tbody/tr[2]/td[2]/div[3]/img')};
    get removeOneTable() {return $('//*[@id="SQLPrivs"]/table/tbody/tr[2]/td[2]/div[2]/img')};
    get removeAllTables() {return $('//*[@id="SQLPrivs"]/table/tbody/tr[2]/td[2]/div[4]/img')};
    ...
    availableTables(table) {
        return $(`//*[@id="avaList"]//option[contains(.,"${table}")]`);
    };
}
export default AddTablesModalLocators;